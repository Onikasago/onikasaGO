# Generated by Django 3.2.7 on 2022-11-21 05:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(blank=True, null=True, verbose_name='魚種')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='oniokoze.fish', verbose_name='魚')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo1', models.ImageField(upload_to='', verbose_name='写真1')),
                ...
                ('capital', models.CharField(max_length=5, verbose_name='都道府県')),
                ...
                ('catchlike', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='catch_like', to='oniokoze.catchlike', verbose_name='釣果いいね')),
                ('fishname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='oniokoze.fishname', verbose_name='魚種')),
                ('userID', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ユーザID')),
            ],
            options={
